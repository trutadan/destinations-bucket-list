    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_column='username', db_index=True, max_length=15, unique=True)),
                ('password', models.CharField(db_column='password', max_length=25)),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('REGULAR', 'Regular')], db_column='role', max_length=10)),
